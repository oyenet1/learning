<div class="col-12 p-8 bg-white">
  <div class="flex justify-between items-center mb-3 px-2">
    <button data-toggle="modal" data-target="#form" class="px-3 py-2 bg-red-600 text-white text-sm focus:outline-none rounded hover:bg-red-500">Add Staff to Branch</button>
  ...
  <table class="table-auto w-full rounded overflow-hidden shadow font-normal">
    ...
    <tbody class="font-normal">
      ...
      <td class="p-2 font-normal  space-x-2 items-center">
        <a href="{{ route('staffs.show', [$branch->state, $staff->name]) }}" class="text-xs text-white btn btn-sm btn-primary" data-toggle="tooltip" title="View staff full details" data-placement="top">
