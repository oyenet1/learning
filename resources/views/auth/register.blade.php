...
<head>
  ...
  <title>Register - 3cyberpractitioners</title>
    ...
    <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
      <div class="flex flex-col overflow-y-auto md:flex-row">
        <div class="h-32 md:h-auto md:w-1/2">
          <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="/img/bg-tb.jpg" alt="Office" />
          <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="/img/bg-tb.jpg" alt="Office" />
        </div>
            ...
            <form action="{{ route('register') }}" method="post">
              ...
              <label class="block text-sm">
                ...
                <input name="name" value="{{ old('name') }}" class="block w-full @error('name')
                  border-red-500
                @enderror mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Jane Doe" />
                @error('name')
              ...
              <label class="block mt-4 text-sm">
                ...
                <input name="email" value="{{ old('email') }}" class="block w-full @error('email')
                  border-red-500
              ...
              <label class="block mt-4 text-sm">
                ...
                <input name="password" value="{{ old('password') }}" class="block w-full @error('password')
                  border-red-500
                @enderror mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="***************" type="password" />
                @error('password')
                <span class="text-sm text-red-600 font-normal">{{ $message }}</span>
                @enderror
              </label>
